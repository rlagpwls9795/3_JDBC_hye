...
INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 1', '샘플 내용 1 입니다.', TO_DATE('2022-09-20 10:30:12','YYYY-MM-DD HH24:MI:SS'), DEFAULT, DEFAULT, 3);
INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 2', '샘플 내용 2 입니다.', TO_DATE('2022-09-21 20:17:09','YYYY-MM-DD HH24:MI:SS'), DEFAULT, DEFAULT, 3);
INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 3', '샘플 내용 3 입니다.', DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 4', '샘플 내용 4 입니다.', DEFAULT, DEFAULT, DEFAULT, 3);
INSERT INTO BOARD 
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 5', '샘플 내용 5 입니다.', DEFAULT, DEFAULT, DEFAULT, 3);
...
(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 1번', DEFAULT, DEFAULT, 3, 3);
INSERT INTO "COMMENT" VALUES
(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 2번', DEFAULT, DEFAULT, 3, 3);
INSERT INTO "COMMENT" VALUES
(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 3번', DEFAULT, DEFAULT, 3, 3);
...
WHERE BOARD_NO=3; -- 입력받은 게시글 번호

COMMIT;

-- 게시글 작성
INSERT INTO BOARD VALUES
(SEQ_BOARD_NO.NEXTVAL, ?, ?, DEFAULT, DEFAULT, DEFAULT, ?)

SELECT * FROM BOARD;

UPDATE BOARD SET DELETE_FL='N' 
WHERE BOARD_NO=1 OR BOARD_NO=4;

SELECT * FROM "COMMENT";

UPDATE "COMMENT" SET DELETE_FL='N'
WHERE COMMENT_NO=1;
