...
private Scanner sc = new Scanner(System.in);
	...
	public void selectEmpId() {
		...
		//입력받은 사번을 DAO의 selectEmpID() 메서드로 전달하여 조회된 사원 정보 반환 받기
	...
	public void insertEmployee() { 
		...
		//INSERT, UPDATE, DELETE 같은 DML구문 수행 후 테이블에 반영된 행의 개수 반환
	...
	public void selectDeptEmp() {
		...
		List<Employee> result = dao.selectDeptEmp(departmentTitle);
		printAll(result);
	}
	...
	public void selectSalaryEmp() {
		...
		System.out.print("급여 검색 : ");
		int inputSalary = sc.nextInt();
		List<Employee> result = dao.selectSalaryEmp(inputSalary);
		printAll(result);
	}
	...
	public void selectDeptTotalSalary() {
		...
		Map<String, Integer> resultMap=dao.selectDeptTotalSalary();
	...
	public void selectJobAvgSalary() {
		...
		Map<String, Double> resultMap=dao.selectJobAvgSalary();
		for(String key : resultMap.keySet()) {
